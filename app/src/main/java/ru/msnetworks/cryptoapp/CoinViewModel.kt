...
import ru.msnetworks.cryptoapp.api.ApiFactory
import ru.msnetworks.cryptoapp.database.AppDatabase
    ...
    private fun loadData() {
        ...
        val disposable = ApiFactory.apiService.getTopCoinsInfo(limit = 50)
            ...
            .subscribe({
                ...
                Log.d("TEST_OF_LOAD", "Success: ${it.toString()}")

            }, {
                Log.d("TEST_OF_LOAD", it.message)
            })
